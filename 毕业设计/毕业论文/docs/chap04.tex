...
\begin{figure}[!htbp]
  ...
  \caption{泄漏控制条件下参考 ckpt 与本研究 M0 的公平对比：左 AUC--ROC、右 AUPR；按"过滤后 ($n=7{,}963$，剔除 ESIBank 训练集中出现过的 P450 酶) / 未过滤 ($n=10{,}999$)"两种测试集并列；灰色虚线分别为 AUC 随机基线（0.5）与 AUPR 阳性基线（$\approx 0.0874$）}
  \label{fig:ch4-fair}
\end{figure}
