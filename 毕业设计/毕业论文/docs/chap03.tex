...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=\textwidth]{./image/数据库.png}
...
\begin{figure}[!htbp]
  ...
  \caption{P450--底物对接复合物结构示例（PDB 2HI4，CYP1A2 + $\alpha$-萘黄酮）：(a) 整体蛋白卡通；(b) 活性口袋放大，灰色棒为血红素，橙色球为中心铁原子，黄色棒为底物 $\alpha$-萘黄酮，青色细棒为 $10~\mathrm{\AA}$ 口袋内代表残基侧链，黑色虚线为 Fe 至底物重原子距离}
