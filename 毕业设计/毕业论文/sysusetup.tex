...
\sysusetup{
  title                = {P450酶底物特异性预测模型构建及应用},
  title*               = {Construction and Application of P450 Enzyme Substrate Specificity Prediction Model},
  author               = {庄泽恒},
  author*              = {ZHUANG Zeheng},
  speciality           = {药学},
  speciality*          = {Pharmacy},
  supervisor           = {王家祺~副教授},
  supervisor*          = {Associate Professor WANG Jiaqi},
  % practice-supervisor  = {XXX~教授, XXX~教授},
  % practice-supervisor* = {Prof. XXX, Prof. XXX},
  % date                 = {2017-05-01},  % 完成时间，默认为今日
  % professional-type    = {专业学位类型},
  % professional-type*   = {Professional degree type},
   department           = {药学院（深圳）},  % 院系，本科生需要填写
   student-id           = {22347083},  % 学号，本科生需要填写
