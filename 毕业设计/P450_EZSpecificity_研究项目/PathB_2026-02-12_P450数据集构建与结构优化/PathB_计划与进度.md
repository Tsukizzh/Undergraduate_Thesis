...
| | Step 6 | 消融实验 + Causal DAG v2 | ✅ 已完成 |
| | | - Phase 1: 比例消融（AUC差异=0.0016，比例无影响） | ✅ |
| | | - Phase 2: 负样本类型88.2% + 结构11.8%（条件分解） | ✅ |
| | | - Causal DAG v2: 5层因果图，11个实验设计 | ✅ |
| | Step 7 | Tier 1 诊断实验 + E7 ESIBank 内部基准 | ✅ 已完成 |
| | | - E1-E6: 底物身份驱动(R²=0.37)，零交互信号(残差AUC=0.509) | ✅ |
| | | - E6扩展: P450=0.517最低，7家族对比 | ✅ |
| | | - E7(内部基准): ESIBank P450 AUC=0.638，配对信号残差=0.612 | ✅ |
| | Step 8 | **通道关闭消融 (E8v1+E8v2)** | ✅ 已完成 |
...
| | | - Val Loss↑ + AUC↑ 分析: 正常现象(BCE vs AUC度量差异) | ✅ |
