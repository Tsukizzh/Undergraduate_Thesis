...
PATHA_ROOT = os.path.abspath(os.path.join(_SCRIPT_DIR, "..", "..", ".."))
base_path = os.path.abspath(os.path.join(PATHA_ROOT, "..", ".."))  # 毕业设计/
exp2_path = os.path.join(base_path, "提取P450过程日志", "2026-01-21_实验二v2_数据重构", "数据文件")
source_path = os.path.join(PATHA_ROOT, "source_data")

# 1. 读取排除列表（58条Photosystem I）
exclude_df = pd.read_csv(
    os.path.join(PATHA_ROOT, "data", "03_Step3_配体分类审核", "05_排除记录",
