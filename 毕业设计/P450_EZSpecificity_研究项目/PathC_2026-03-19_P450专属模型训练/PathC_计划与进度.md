...
> **创建日期**: 2026-03-19
> **当前状态**: C2 EXP001 ✅ (0.7730) | C3 底物分类 ✅ | EXP002a ✅ (0.782) | EXP002b ✅ (0.7889) | **Step 13 EXP003 ✅ 残基级几何特征 (Test AUC=0.7914, +0.0025, 2026-04-12)**
...
└── C3_P450专属模型训练 🔄
    ...
    ├── Step 07: 15Å口袋消融 ⏳（可能跳过）
    ├── Step 08: 6A15模板重预测结构 ⏳
    ├── Step 09: 底物类别辅助MLP ⏳
    ├── Step 10: 序列<40%相似度划分 ⏳
    ├── Step 11-12: 负样本验证 + 距离选构象 ⏳
    ├── **Step 13: ⭐残基级几何特征注入 ✅**（φ/ψ/χ1→EGNN 31→37维, EXP003 Test AUC=0.7914 +0.0025, 2026-04-12）
    └── **Step 14: ⭐双尺度结构编码 ⏳**（新增残基级GNN通道, 依赖Step 13验证）
```
