...
def _process_single_shard(args_tuple):
    ...
    prot_pos_chunks, prot_elem_chunks, prot_aa_chunks, prot_bb_chunks, prot_het_chunks = [], [], [], [], []
...
def self_test(output_dir: Path) -> None:
    ...
    protein_atom_feature = torch.cat([prot_elem_oh, prot_aa_oh, prot_bb_f, prot_het_f], dim=1) # (N_prot, 28)
    protein_x = torch.cat([
