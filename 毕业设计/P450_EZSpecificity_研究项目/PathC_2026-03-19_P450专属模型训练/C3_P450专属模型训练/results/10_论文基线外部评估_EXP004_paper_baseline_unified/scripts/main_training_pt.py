...
def test_evaluate(args, config):
    ...
    loader = DataLoader(
        ...
        num_workers=args.num_workers, follow_batch=["ligand_index"],
    )
...
def main():
    ...
    if best_ckpt and os.path.exists(best_ckpt):
        ...
        test_model = _apply_runtime_patches(SS.load_from_checkpoint(best_ckpt, config=config))
        SS.transfer_batch_to_device = _fast_transfer  # re-apply
