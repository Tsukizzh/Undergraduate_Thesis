...
**输入文件（读取）：**
```
C:\Users\Administrator\Desktop\EZSpecificity_Project\P450_EZSpecificity_研究项目\PathA_2026-01-08_模型评估测试集构建\data\03_Step3_配体处理与数据集构建\02_配体分类并行验证\01_输入数据_chunks\chunk_02.csv
```

**输出文件夹（写入数据）：**
```
C:\Users\Administrator\Desktop\EZSpecificity_Project\P450_EZSpecificity_研究项目\PathA_2026-01-08_模型评估测试集构建\data\03_Step3_配体处理与数据集构建\02_配体分类并行验证\02_输出数据_results\chunk_02_results
```

**输出文件：**
- `C:\Users\Administrator\Desktop\EZSpecificity_Project\P450_EZSpecificity_研究项目\PathA_2026-01-08_模型评估测试集构建\data\03_Step3_配体处理与数据集构建\02_配体分类并行验证\02_输出数据_results\chunk_02_results\verified_results.jsonl` - 验证结果（每条一行JSON）
- `C:\Users\Administrator\Desktop\EZSpecificity_Project\P450_EZSpecificity_研究项目\PathA_2026-01-08_模型评估测试集构建\data\03_Step3_配体处理与数据集构建\02_配体分类并行验证\02_输出数据_results\chunk_02_results\verification_report.md` - 验证报告

**操作日志（写入文档）：**
```
C:\Users\Administrator\Desktop\EZSpecificity_Project\P450_EZSpecificity_研究项目\PathA_2026-01-08_模型评估测试集构建\sessions\03_Step3_配体处理与数据集构建\02_配体分类并行验证\chunk_02_session_log.md
```
